...
class AboutDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('AboutID', '{{ $id }}')
            ->rawColumns(['AboutID', 'action', 'name_data', 'status']);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('description_uz')->exportable(false)->printable(false)->searchable(true)->visible(false),
            Column::make('DT_RowIndex')->title('#')->style('white-space: nowrap;')->addClass('text-center')->searchable(false)->sortable(false),
            Column::computed('description_uz')->style('white-space: nowrap; text-align: left;')->title(trans('Nomi'))->searchable(false),

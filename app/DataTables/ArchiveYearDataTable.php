...
class ArchiveYearDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('ArchiveGalleryID', '{{ $id }}')
            ->rawColumns(['ArchiveGalleryID', 'action', 'name_data', 'status']);
    }

    /**
     * Get the query source of dataTable.
     */
    public function query(ArchiveYear $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('year')->exportable(false)->printable(false)->searchable(true)->visible(false),
            ...
            ->width('1')->title(trans('')),
            Column::computed('ArchiveGalleryID')
            ->exportable(false)
                ->printable(false)
                ->searchable(false)
                ->visible(false),
    ...
    {
        return 'ArchiveYear_' . date('YmdHis');
    }
}

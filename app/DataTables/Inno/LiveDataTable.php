...
class LiveDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('InnoLiveID', '{{ $id }}')
            ->rawColumns(['InnoLiveID', 'action', 'name_data', 'status']);
    }

    /**
     * Get the query source of dataTable.
     */
    public function query(LiveVideos $model): QueryBuilder
    {

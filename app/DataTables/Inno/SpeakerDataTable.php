...
class SpeakerDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('InnoSpeakerID', '{{ $id }}')
            ->rawColumns(['InnoSpeakerID', 'action', 'name_data', 'status']);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('full_name_uz')->exportable(false)->printable(false)->searchable(true)->visible(false),
            Column::make('full_name_en')->exportable(false)->printable(false)->searchable(true)->visible(false),
            Column::make('DT_RowIndex')->title('#')->style('white-space: nowrap;')->addClass('text-center')->searchable(false)->sortable(false),
            Column::computed('name_data')->style('white-space: nowrap; text-align: left;')->title(trans('Spiker ismi'))->searchable(false),

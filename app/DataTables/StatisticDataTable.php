...
class StatisticDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('StatisticID', '{{ $id }}')
            ->rawColumns(['StatisticID', 'action', 'name_data', 'status']);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('name_uz')->style('white-space: nowrap; text-align: left;')->title(trans('Nomi'))->searchable(false),

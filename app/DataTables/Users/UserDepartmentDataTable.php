...
class UserDepartmentDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('UserDeptID', '{{ $id }}')
            ->rawColumns(['UserDeptID', 'action', 'name_data', 'status']);
    }

    /**
     * Get the query source of dataTable.
     */
    public function query(UserDepartment $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('userdepartment-table')
    ...
    {
        return 'UserDepartment_' . date('YmdHis');
    }
}

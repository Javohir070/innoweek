...
use App\DataTables\News\NewsCategoryDataTable;
...
class NewsCategoryController extends Controller
{
    ...
    public function index(NewsCategoryDataTable $dataTable)
    {
        ...
        $data_count = NewsCategory::count();
        return $dataTable->render('admin.news.categories', compact('data_count'));
    }
    ...
    public function storeData(Request $request)
    {
        try {
            $inputs = $request->all();
            $data = NewsCategory::where('id', $inputs['id'])->first() ?? new NewsCategory;
            $rules = [
    ...
    public function destroyData(Request $request)
    {
        try {
            $inputs = $request->all();
            $data = NewsCategory::findOrFail($inputs['data_id']);
            if ($data) {
                $data->delete();

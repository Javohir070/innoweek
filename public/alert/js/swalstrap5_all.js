        ...
        get modalContent() {
            ...
            return `<div class="modal fade ${this.customClass.container}" id="modal_${this.currentId}" tabindex="-1" role="dialog" aria-labelledby="${this.config.title}" 
                        ...
                        <div class="modal-dialog modal-swal ${this.customClass.popup} ${this.config.position == 'top' || this.config.position == 'top-center' ? '' : 'modal-dialog-centered'}" role="document">
                            <div class="modal-content pb-3 px-0" style="background-color: #041A57; border: 1px solid #041A57; border-radius: 10px; color: #fff;">
                                ...
                                <div class="modal-body px-4 py-0">
                                    <div class="container-fluid d-flex flex-column">
                                        ...
                                        <input data-swalstrap="input" style="margin: 14px auto;  border: 2px solid #c4c3ff !important;  padding: 12px 12px 12px 17px;  border-radius: 40px;  outline: none;  color: #fff;  transition: all .2s ease-out;  font-size: 18px;  text-align: center;  background: transparent;  width: 100% ;" class=" ${this.customClass.input} ${this.display('input')}" 
                                ...
                                <div data-swalstrap="actions" 
                                    ...
                                    <button data-swalstrap="btn-confirm" type="button" style="color: #fff; border-radius: 40px; padding: 12px 10px; font-weight: 400; margin-top: 5px; width: 40%; border: 2px solid rgb(42, 7, 249); outline: none; transition: all .2s ease-out; font-size: 18px; text-align: center; background: rgb(42, 7, 249);" class="${this.customClass.confirmButton} ${this.display('btn-confirm')}">
                                    ...
                                    <button data-swalstrap="btn-cancel" type="button" style="color: #fff; border-radius: 40px; padding: 12px 10px; font-weight: 400; margin-top: 5px; width: 40%; border: 2px solid rgb(42, 7, 249); outline: none; transition: all .2s ease-out; font-size: 18px; text-align: center; background: #d33;" class="${this.customClass.cancelButton} ${this.display('btn-cancel')}"

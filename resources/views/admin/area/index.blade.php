    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Loyiha maydonlari ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida loyihalar uchun ajratiladigan maydonlar boshqaruvi.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.pa.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Maydon qo'shish</a>
        </div>
    </div>

            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        ...
                        <h6><i data-feather="users" class="feather-user"></i>Jami Valyantorlar soni <span>{{ $val_count }}</span></h6>
                        <h6><i data-feather="users" class="feather-user"></i>Jami kirganlar soni <span>{{ $enters_count }}</span></h6>
                        <h6><i data-feather="users" class="feather-user"></i>Jami chiqganlar soni <span>{{ $exits_count }}</span></h6>
                    </div>

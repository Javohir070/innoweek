...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4>Tadbir live ma'lumotlarni kiritish</h4>
            <h6>
                InnoWeek haftaligi doirasida tashkil etiladigan tadbirlar uchun live larni boshqarish
            </h6>
        </div>
    </div>
    <ul class="table-top-head">
        ...
        <li>
            <div class="page-btn">
                <a href="{{ route('admin.live.index') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Orqaga
                    qaytish</a>
            </div>
        </li>
    </ul>
...
<!-- /add -->
<form action="{{ route('admin.live.store') }}" method="POST" enctype="multipart/form-data" class="was-validated">
    @csrf
            ...
            <div class="tab-content">
                <div class="tab-pane show active" id="tab-uzbek">
                    <div class="row g-3">
                        <div class="col-lg-9 col-sm-9 col-12">
                            <div class="input-blocks">
                                <label>Live nomi *</label>
                                <div class="input-groupicon select-code">
                                    <input type="text" name="title_uz" value="{{ $data->title_uz ?? null }}" placeholder="Live nomini kiriting..." required class="p-2" />
                                </div>
                                @error('title_uz')
                        ...
                        <div class="col-lg-3 col-sm-3 col-md-3 col-12">
                            <div class="input-blocks">
                                <label>Live boshlanish vaqti *</label>
                                <div class="input-groupicon select-code">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-3 col-sm-3 col-12">
                            <div class="input-blocks">
                                <label>Live turi *</label>
                                <select name="type_id" class="js-example-basic-single select2" required>
                                    <option value="{{ null }}">- Tanlang -</option>
                                    <option value="1" @if(isset($data->type_id) && $data->type_id == 1) selected @endif>B2B Live</option>
                                    <option value="2" @if(isset($data->type_id) && $data->type_id == 2) selected @endif>Live 360</option>
                                </select>
                                @error('archive_id')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="tab-pane" id="tab-russian">
                    <div class="row g-3">
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="input-blocks">
                                <label>Live nomi (Ruscha)</label>
                                <div class="input-groupicon select-code">
                                    <input type="text" name="title_ru" value="{{ $data->title_ru ?? null }}" placeholder="Live nomini kiriting..." class="p-2" />
                                </div>
                                @error('title_ru')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="tab-pane" id="tab-english">
                    <div class="row g-3">
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="input-blocks">
                                <label>Live nomi (Ingiliz tilida)</label>
                                <div class="input-groupicon select-code">
                                    <input type="text" name="title_en" value="{{ $data->title_en ?? null }}" placeholder="Live nomini kiriting..." class="p-2" />
                                </div>
                                @error('title_en')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>

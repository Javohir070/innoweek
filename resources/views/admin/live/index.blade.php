    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Tadbirlarda ko'rsatiladigan live lar ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida tashkil qilinadigan tadbirlar uchun maxsus live ko'rsatuvlar ro'yxati.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.live.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Live kiritish</a>
        </div>
    </div>
            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami livelar soni <span>{{$data_count}}</span></h6>
                    </div>

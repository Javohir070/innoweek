    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Yangilik kategoriyalari ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida berib boriladigan yangiliklar kategoriyasi boshqaruvi.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.nc.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Kategoriya qo'shish</a>
        </div>
    </div>
            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami yo'nalishlar soni <span>{{$data_count}}</span></h6>
                    </div>

    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Takliflar ro'yxati</h4>
                <h6>Innoweek doirasida yuborilgan takliflar ro'yxati.</h6>
            </div>
        </div>
            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami loyihalar soni
                            <span>{{$data_count}}</span></h6>
                    </div>

    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Loyiha yo'nalishlari ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida loyihalar qabul qiluvchi yo'nalishlari boshqaruvi.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.pc.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Yo'nalish qo'shish</a>
        </div>
    </div>

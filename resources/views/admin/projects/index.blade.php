...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-project"><i data-feather="plus-circle" class="me-2"></i> Loyiha kiritish</a>
        </div>
    </div>
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="input-blocks">
                                    ...
                                    <select class="select" name="department_id">
                                        <option {{ null }}>Boshqarmani tanlang</option>

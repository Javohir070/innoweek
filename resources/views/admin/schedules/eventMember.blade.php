    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Tadbirlar mehmonlari ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida tashkil qilinadigan tadbirlarda qatnashuvchi mehmonlar ro'yxati.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.schedules.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Jadval kiritish</a>
        </div>
    </div>
    ...
    <div class="card table-list-card">
        ...
        <div class="card-body pb-0">
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami mehmonlar soni <span>{{$data_count}}</span></h6>
                    </div>
            ...
            <div class="card" id="filter_inputs">
                <div class="card-body pb-0">
                    <form action="{{ route('admin.events.members') }}" method="GET">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-12">
                                <div class="input-blocks">
                                    ...
                                    <select class="select" name="event_id">
                                        <option>Tadbir nomini tanlang</option>
                                        @foreach ($schedules as $item)
                                        <option value="{{ $item->id }}" @if (isset($inputs['event_id']) && $inputs["event_id"] = $item->id) selected @endif>{{ $item->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>

    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Tadbirlar jadvali ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida tashkil qilinadigan tadbirlar jadvali ro'yxati.</h6>
            </div>
        </div>
            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami tadbirlar soni <span>{{$data_count}}</span></h6>
                    </div>

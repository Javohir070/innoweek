    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Spikerlar ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida ishtirok etuvchi spikerlar ro'yxati.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.speakers.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Spiker kiritish</a>
        </div>
    </div>
            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami spikerlar soni <span>{{$data_count}}</span></h6>
                    </div>

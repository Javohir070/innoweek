...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            ...
            <h6>
                Statistikalar kiritish va tahrirlash
            </h6>
        </div>
    </div>
    <ul class="table-top-head">
        ...
        <li>
            <div class="page-btn">
                <a href="{{ route('admin.statistic.index') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Orqaga
                    qaytish</a>
            </div>
        </li>
    </ul>
...
<!-- /add -->
<form action="{{ route('admin.statistic.store') }}" method="POST" enctype="multipart/form-data" class="was-validated">
    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 col-6">
                                    <div class="input-blocks">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="statistic" value="{{ $data->statistic ?? null }}" placeholder="Statistikani kiriting" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-12 col-6">
                                    <div class="input-blocks">
                                        ...
                                        <div class="mb-3">
                                            <input type="file" class="form-control" aria-label="file example" name="icon" @if (!isset($data->icon)) required @endif/>
                                            @if (isset($data->icon) && !empty($data->icon))
                                                <div><a target="_blank" href="{{ asset($data->icon) }}">{{ __("Rasmni ko'rish")}}</a></div>
                                            @endif
                                        </div>
                                    </div>
                                </div>

...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4>{{ isset($data->id ) ? "Ma'lumotlarni tahrirlash" : "Loyiha turi qo'shish"}}</h4>
            <h6>
                InnoWeek haftaligi doirasida ko'rgazmaga qo'yiladigan loyiiha turlari
    ...
    <ul class="table-top-head">
        ...
        <li>
            <div class="page-btn">
                <a href="{{ route('admin.pt.index') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Orqaga
                    qaytish</a>
            </div>
        </li>
    </ul>
...
<!-- /add -->
<form action="{{ route('admin.pt.store') }}" method="POST" enctype="multipart/form-data" class="was-validated">
    @csrf

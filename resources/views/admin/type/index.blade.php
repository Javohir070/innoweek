...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('admin.pt.info') }}" class="btn btn-added" ><i data-feather="plus-circle" class="me-2"></i> Loyiha turi kiritish</a>
        </div>
    </div>
                ...
                <div class="search-path d-flex align-items-center search-path-new">
                    ...
                    <div class="form-sort">
                        ...
                        <select class="select">
                            ...
                            <option>Yangi ma'lumotlar</option>
                            <option>Eski ma'lumotlar</option>
                        </select>
                    </div>
                </div>
            </div>

...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4>{{ isset($data->id ) ? "Ma'lumotlarni tahrirlash" : "Boshqarma qo'shish"}}</h4>
            <h6>
                InnoWeek haftaligi doirasida qabul qilinayotgan loyihalarni nazorat qiluvchi boshqarmalarni kiritish va tahrirlash
            </h6>
        </div>
    </div>
    <ul class="table-top-head">
        ...
        <li>
            <div class="page-btn">
                <a href="{{ route('admin.ud.index') }}" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Orqaga
                    qaytish</a>
            </div>
        </li>
    </ul>
...
<!-- /add -->
<form action="{{ route('admin.ud.store') }}" method="POST" enctype="multipart/form-data" class="was-validated">
    @csrf

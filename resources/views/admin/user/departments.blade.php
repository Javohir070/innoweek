    ...
    <div class="page-header">
        <div class="add-item d-flex">
            <div class="page-title">
                <h4>Loyiha boshqarmalari ro'yxati</h4>
                <h6>Innoweek ko'rgazmasi doirasida loyihalarni qabul qiluvchi boshqarmalar boshqaruvi.</h6>
            </div>
        </div>
        ...
        <div class="page-btn">
            <a href="{{ route('admin.ud.info') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i> Boshqarma qo'shish</a>
        </div>
    </div>

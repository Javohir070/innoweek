...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('') }}" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Tashkilot
                qo'shish</a>
        </div>
    </div>
            ...
            <div class="table-top table-top-two table-top-new">
                ...
                <div class="search-set mb-0">
                    <div class="total-employees">
                        <h6><i data-feather="users" class="feather-user"></i>Jami tashkilotlar soni <span>21</span></h6>
                    </div>

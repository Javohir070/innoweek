...
@section('head_title', trans("site.Ticket.Electronic Ticket"))
@section('content')
      ...
      <div class="col-lg-10">
        <div class="regpanel">
          <div class="qrcode pt-2">
            ...
            <h3 class="text-center text-white"> Ticket to enter InnoWeek-2024 </h3>
            ...
            <div class="grid-container">
              <p class="d-flex align-items-center space-x-2 text-white">
                ...
                <span class="ml-autoi text-white ms-3">16.11.2024</span>
              </p>
              ...
              <p class="d-flex align-items-center space-x-2 mt-2">
                ...
                <span class="ml-autoi ms-3">14-16.11.2024 11:00</span>
            ...
            <div class="inves-footer">
              <p class="inveestor text-white text-center mt-77">{{ $profession->name ?? "" }}</p>
            </div>
          </div>
          <div class="boxes">
            <form class="reg-box">
              <h3>{{ __('site.Ticket.Download Title')}}</h3>
              ...
              <div class="my-3" style="margin-left: 27%">
                <a href="https://play.google.com/store/apps/details?id=com.mimaxgroup.innomobileapp"><img class="downloads playM" width="200" src="{{ asset('/front/image/icon/playmarket.png') }}" alt=""></a>
